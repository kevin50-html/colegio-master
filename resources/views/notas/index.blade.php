            ...
            <div class="col-md-9 col-lg-10">
                <div class="main-content p-4">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
                        <div>
                            <h1 class="h3 mb-1">Notas</h1>
                            <p class="text-muted mb-0">Selecciona un curso para gestionar las calificaciones de sus materias.</p>
                        </div>
                        <form method="GET" action="{{ route('notas.index') }}" class="d-flex gap-2">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4">
                                            <div class="card border-0 h-100 shadow-sm">
                                                <div class="card-body d-flex flex-column">
                                                    ...
                                                    <div class="mt-auto">
                                                        <a href="{{ route('notas.curso', $curso) }}" class="btn btn-primary w-100">
                                                            <i class="fas fa-arrow-right me-1"></i> Ver materias y calificar
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
