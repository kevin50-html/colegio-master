...
@section('title', 'Nueva Materia - ' . $curso->nombre)
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10">
            <div class="main-content p-4">
                <div class="mb-4">
                    <a href="{{ route('academico.cursos.materias.index', $curso) }}" class="btn btn-link text-decoration-none p-0">
                        <i class="fas fa-arrow-left me-1"></i>Volver a materias
                    </a>
                </div>
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white">
                        <h2 class="h5 mb-0">Nueva materia para {{ $curso->nombre }}</h2>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('academico.cursos.materias.store', $curso) }}" method="POST" class="row g-3">
                            @csrf
                            <div class="col-md-6">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="intensidad_horaria" id="intensidad_horaria" min="1" max="30" class="form-control @error('intensidad_horaria') is-invalid @enderror" value="{{ old('intensidad_horaria') }}">
