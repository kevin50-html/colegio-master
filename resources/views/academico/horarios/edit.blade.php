...
@section('title', 'Editar Horario - ' . $periodo->nombre)
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10">
            <div class="main-content p-4">
                <div class="mb-4">
                    <a href="{{ route('academico.periodos.horarios.show', [$periodo, $horario]) }}" class="btn btn-link text-decoration-none p-0">
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="{{ route('academico.periodos.horarios.update', [$periodo, $horario]) }}" method="POST" class="row g-3">
                            @csrf
                            @method('PUT')
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="aula" id="aula" class="form-control @error('aula') is-invalid @enderror" value="{{ old('aula', $horario->aula) }}">
                                @error('aula')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" name="modalidad" id="modalidad" class="form-control @error('modalidad') is-invalid @enderror" value="{{ old('modalidad', $horario->modalidad) }}">
                                @error('modalidad')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
