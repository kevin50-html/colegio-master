...
@section('title', 'Editar periodo - ' . $cursoMateria->curso->nombre . ' / ' . $cursoMateria->materia->nombre)
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10">
            <div class="main-content p-4">
                <div class="mb-4">
                    <a href="{{ route('academico.curso-materias.periodos.show', [$cursoMateria, $periodo]) }}" class="btn btn-link text-decoration-none p-0">
                        <i class="fas fa-arrow-left me-1"></i>Volver al periodo
                    </a>
                </div>
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white">
                        <h2 class="h5 mb-0">Editar periodo</h2>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('academico.curso-materias.periodos.update', [$cursoMateria, $periodo]) }}" method="POST" class="row g-3">
                            @csrf
                            @method('PUT')
                            <div class="col-md-6">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="orden" id="orden" class="form-control @error('orden') is-invalid @enderror" value="{{ old('orden', $periodo->orden) }}" min="1">
                                @error('orden')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
